    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '食事・トレーニング・ウェルネスをAIと一緒に管理して、理想の体づくりをサポートします。',
            textAlign: TextAlign.center,
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              _featurePill(Icons.water_drop_rounded, '水分・ウェルネス', scheme),
              const SizedBox(width: 8),
              _featurePill(Icons.smart_toy_rounded, 'AIコーチ', scheme),
            ],
          ),
        ],
      ),
  ...
  Widget _buildFeaturesPage(ColorScheme scheme) {
    final features = [
      (
        ...
        '食事トラッキング',
        'バーコード・AI画像解析・コミュニティ食品DBで食品を簡単登録。マクロ栄養素を自動計算。',
      ...
      (
        ...
        'トレーニング管理',
        'ルーティン・プランニングで効率化。1RMと筋肉ヒートマップで進捗を可視化。',
      ...
      (
        ...
        '睡眠・歩数・水分',
        'HealthKitと連携して睡眠・歩数を自動取得。水分補給リマインダーで健康習慣をサポート。',
      ...
      (
        ...
        'AIコーチ',
        'AIコーチとトレーナーチャットがあなたの記録に基づいた個別アドバイスを提供。',
              ...
              child: Column(
                children: [
                  _startTip(Icons.qr_code_scanner_rounded,
                      'バーコードスキャン・AI解析で食品を素早く登録', scheme),
                  const SizedBox(height: 8),
                  _startTip(Icons.workspace_premium_rounded,
                      'プレミアムプランでAPIキー不要のAIコーチが利用できます', scheme),
                  const SizedBox(height: 8),
                  _startTip(Icons.health_and_safety_rounded,
                      'ヘルスケアアプリと連携すると睡眠・歩数が自動取得できます', scheme),
                  const SizedBox(height: 8),
                  _startTip(Icons.water_drop_rounded,
                      '設定から水分補給リマインダーを有効にして習慣をサポート', scheme),
                ],
              ),
            ),
          ),
